...
namespace internal {
  ...
  // SparseQR_traits
  template <typename T> struct SparseQR_traits {  };
  template <class T, int Rows, int Cols, int Options> struct SparseQR_traits<Matrix<T,Rows,Cols,Options>> { 
    typedef Matrix<T,Rows,1,Options> Vector;
  };
  template <class Scalar, int Options, typename Index> struct SparseQR_traits<SparseMatrix<Scalar,Options,Index>> { 
...
class SparseQR : public SparseSolverBase<SparseQR<_MatrixType,_OrderingType> >
{
  ...
  public:
    ...
    typedef SparseQRMatrixQReturnType<SparseQR> MatrixQType;
...
// xxawf boilerplate all this into BlockSparseQR...
...
struct SparseQR_QProduct : ReturnByValue<SparseQR_QProduct<SparseQRType, Derived> >
{
  ...
  typedef typename internal::SparseQR_traits<MatrixType>::Vector SparseVector;
...
{  
  ...
  SparseQR_QProduct<SparseQRType, SparseMatrix<_Scalar, _Options, _Index>> operator*(const SparseMatrix<_Scalar, _Options, _Index>& other)
  {
    return SparseQR_QProduct<SparseQRType, SparseMatrix<_Scalar, _Options, _Index>>(m_qr, other, false);
  }
...
struct SparseQRMatrixQTransposeReturnType
{
  ...
  SparseQR_QProduct<SparseQRType, SparseMatrix<_Scalar, _Options, _Index>> operator*(const SparseMatrix<_Scalar,_Options,_Index>& other)
  {
    return SparseQR_QProduct<SparseQRType, SparseMatrix<_Scalar, _Options, _Index>>(m_qr, other, true);
  }
  const SparseQRType& m_qr;
};
